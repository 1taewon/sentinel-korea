            ...
            <div className="expanded-globe-overlay">
              ...
              <div className="expanded-globe-body">
                  ...
                  <div className="globe-korea-overlay">
                    ...
                    <div className="globe-korea-overlay-section globe-korea-overlay-legend">
                      ...
                      <div className="globe-legend-row">
                        ...
                        <div><strong>선 굵기</strong><small>한국 관련도 점수가 높을수록 굵어집니다 (질병/거리/이동량(인천공항 실측 여객)/최신성 통합).</small></div>
                      </div>
                      <div className="globe-legend-row">
                ...
                <aside className="globe-context-panel">
                  ...
                  <p>
                    국제 신호는 질병 심각도, <strong>한국 이동량(인천공항 국가별 실측 도착 여객)</strong>, 거리, 예상 밖 이벤트,
